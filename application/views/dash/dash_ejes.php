...
<section>
    <div class="" style="background-color: #f2f4f5;">
        <h3 class="font-weight-bold text-center">AVANCE POR EJE RECTORhhh</h3>
        <div class="row">
            <div class="col-4 mb-4">
                ...
                <div class="row">
                    <div class="col-8 text-center"><h1 style="font-weight:700;color:#000080;" class="count"><?=Decimal($pat_totales);?></h1>
                        <h5 style="font-weight:500;">Dependencias</h5></div>
            ...
            <div class="col-4 mb-4">
                ...
                <div class="row">
                    <div class="col-8 text-center"><h1 style="font-weight:700;color:#000080;" class="count"><?=Decimal($act_totales);?></h1>
                        <h5 style="font-weight:500;">Planes Anuales</h5></div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row text-center mb-2">
                                    <div class="col-4">
                                        ...
                                        <span class="font-14">Dependencias </span></div>
                                    <div class="col-4"><h4 class="m-b-0" style="font-weight:700"><?=${'eje_'.$d->iIdEje}['actividades']?></h4>
                                        <span class="font-14">Planes Anuales</span></div>
                                ...
                                <div class="row text-center mb-2">
                                    <div class="col-4">
                                        <h4 class="mb-0" style="font-weight:700"><?=${'eje_'.$d->iIdEje}['hombres']?> </h4>
                                        <span class="font-14">Hombres </span></div>
                                    <div class="col-4"><h4 class="m-b-0" style="font-weight:700"><?=${'eje_'.$d->iIdEje}['mujeres']?></h4>
                                        <span class="font-14">Mujeres</span></div>
                                    <div class="col-4"><h4 class="m-b-0" style="font-weight:700"><?=${'eje_'.$d->iIdEje}['total']?> </h4>
                                        <span class="font-14">Total</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
