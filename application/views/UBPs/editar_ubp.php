        ...
        <div class="card">
            <div class="card-body">
                ...
                <form class="needs-validation was-validated" onsubmit="guardarUBP(this,event);">
                    <div class="form-row">
                        <div class="col-md-2">
                            <label for="validationCustom01">Clave POA</label>
                        ...
                        <div class="col-md-4 mb-3">
                            <label for="validationCustom02">Nombre del POA</label>
                        ...
                        <div class="col-md-4">
                            <label for="validationCustom03">Tipo POA</label>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <select class="custom-select select2" name="ProgP">
                                    <option value="<?= $consulta->iIdProgramaPresupuestario ?>" required="required"><?= $consulta->vProgramaPresupuestario ?></option>
