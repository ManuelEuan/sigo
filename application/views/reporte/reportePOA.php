  ...
  <div class="page-breadcrumb">
    <div class="row">
      <div class="col-5 align-self-center">
        <h4 class="page-title">Reporte Programa Operativo Anual SF</h4>
      </div>
    </div>
  </div>
</section>
...
<script>
  ...
  function generarExcel() {
    ...
    if (anio == '' || anio == 0 || anio == null) {
      ...
      $.ajax({
        type: "POST",
        url: "<?= base_url() ?>index.php/C_reportesPOA/generarrepo",
  ...
  function generarPDF() {
    ...
    if (anio == '' || anio == 0 || anio == null) {
      ...
      $.ajax({
        type: "POST",
        url: "<?= base_url() ?>index.php/C_reportesPOA/generarrepoPDF",
        data: $("#frmReport").serialize(),
        beforeSend: function(xhr) {
          Swal.fire({
            position: 'center',
