  ...
  <div class="page-breadcrumb">
    <div class="row">
      <div class="col-5 align-self-center">
        <h4 class="page-title">Reporte Programa Operativo Anual</h4>
      </div>
    </div>
  </div>
</section>
...
<script>
  ...
  function generarFichas() {
    ...
    $.ajax({
      type: "POST",
      url: "<?= base_url() ?>index.php/C_reporte/listar_actividades",
      data: data,
  ...
  function comprimir(dir) {
    $.ajax({
      type: "POST",
      url: "<?= base_url() ?>index.php/C_reporte/comprimir_directorio",
      data: "dir=" + dir,
      success: function(resp) {
        resp = JSON.parse(resp);
        if (resp.status) {
