...
<script>
  ...
  function generarPDF() {
    ...
    if (anio == '' || anio == 0 || anio == null) {
      ...
      $.ajax({
        type: "POST",
        url: "<?= base_url() ?>index.php/C_rclinica/generarrepoPDF",
  ...
  function generarFichas() {
    ...
    $.ajax({
      type: "POST",
      url: "<?= base_url() ?>index.php/C_rclinica/listar_actividades",
      data: data,
  ...
  function comprimir(dir) {
    $.ajax({
      type: "POST",
      url: "<?= base_url() ?>index.php/C_rclinica/comprimir_directorio",
      data: "dir=" + dir,
      success: function(resp) {
        resp = JSON.parse(resp);
        if (resp.status) {
  ...
  function dependencia() {
    ...
    $.ajax({
      type: "POST",
      url: "<?= base_url() ?>index.php/C_rclinica/dependencias",
      data: 'id=' + id,
      success: function(r) {
        $("#selDep").html(r);
      },
  ...
  function generarExcel() {
    ...
    if (anio == '' || anio == 0 || anio == null) {
      ...
      $.ajax({
        type: "POST",
        url: "<?= base_url() ?>index.php/C_rclinica/generarrepo",
        data: $("#frmReport").serialize(),
        beforeSend: function(xhr) {
          Swal.fire({
            position: 'center',
