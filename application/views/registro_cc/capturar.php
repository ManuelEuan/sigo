            ...
            <form class="needs-validation was-validated" onsubmit="guardar(this,event);">
                ...
                <div class="form-row">
                    <div class="col-md-4">
                        ...
                        <input type="number" class="form-control" id="vCP" name="vCP" aria-invalid="false" required=""  value="<?=$vCP?>" maxlength="5">
                        <div class="invalid-feedback">
                            Este campo no puede estar vacio.
                        </div>
                    </div>
                ...
                <div class="form-row">
                    <div class="col-md-12">
                        <label for="iIdMotivoCC">Problema</label>
                        <select class="form-control search" id="iIdMotivoCC" name="iIdMotivoCC" required="required">
                            <option value="">--Seleccione--</option>
                            <?=$options_motivocc?>
                        </select>
                        <div class="invalid-feedback">
