    ...
    <div class="card">
        <div class="card-body">
            ...
            <form class="needs-validation was-validated" onsubmit="guardarDetalles(this,event);">
                ...
                <div class="form-row">
                    <div class="col-md-6 mb-6">
                        <label for="validationCustom04">Nombre del responsable</label>
                        <input type="text" class="form-control input-lectura" maxlength="255" id="vResponsable" name="vResponsable" value="<?= $consulta->vResponsable ?>">
                    </div>
                    <div class="col-md-6 mb-6">
                        <label for="validationCustom04">Cargo del responsable</label>
                        <input type="text" class="form-control input-lectura" maxlength="255" id="vCargo" name="vCargo" value="<?= $consulta->vCargo ?>">
                    </div>
                </div>

                <div class="form-row">
                    <div class="col-md-6 mb-6">
                        <label for="validationCustom04">Correo del responsable</label>
                        <input type="text" class="form-control input-lectura" maxlength="255" id="vCorreo" name="vCorreo" value="<?= $consulta->vCorreo ?>">
                    </div>
                    <div class="col-md-6 mb-6">
                        <label for="validationCustom04">Teléfono del responsable</label>
                        <input type="text" class="form-control input-lectura" maxlength="20" id="vTelefono" name="vTelefono" value="<?= $consulta->vTelefono ?>">
                    </div>
                </div>
                <?php if($per_ods > 0){ ?>
                <div class="row">
                ...
                <div class="form-row">
                    <div class="col-md-6 mb-6">
                        ...
                        <select class="select2 select-lectura form-control custom-select" style="width: 100% !important; height:36px !important;" required="" name="fuenteF" id="fuenteF">
                            <option value="0">Seleccione...</option>
                    ...
                    <div class="col-md-4 mb-4">
                        ...
                        <input class="input-lectura form-control" id="montoF" name="montoF" <?= $requerido ?> type="text" onKeypress="return onlyDigits(event,'decOK');" maxlength="18">
                        <div class="invalid-feedback">
                            Este campo no puede estar vacio.
                        </div>
                    </div>
                    <div class="col-md-2 mb-2" style="margin-top: 30px;">
                        <button type="button" class="btn-lectura btn waves-effect waves-light btn-primary" onclick="agregarCarritoF()">+ Agregar</button>
                    </div>
                </div>               
                <br>
                <div class="content">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <label for="validationCustom04">Monto de la fuente </label>
                        <input align='right' class="input-lectura form-control" id="montoFinal" name="montoFinal" type="text" value="<?php echo $montoFinal; ?>" disabled>
                        <div class="invalid-feedback">
                            Este campo no puede estar vacio.
                        </div>
                    </div>
                ...
                <hr>               
                <br><br>
                <legend>Alineación POA</legend>
                <div class="form-row">
                    <div class="col-md-8 mb-8">
                        <label for="validationCustom04">Número POA</label>
                        <div class="form-group">
                            <select class="select-lectura select2 form-control custom-select" style="width: 100% !important; height:36px !important;" required="" name="NumUBP" id="NumUBP">
                                <option value="0">Seleccione...</option>
                                <?php foreach ($ubp as $value) { ?>
                                    <option value="<?php echo $value->iIdUbp ?>"><?= $value->vClave.' '.trim($value->vUBP) ?></option>
                                <?php } ?>
                            </select>
                            <div class="valid-feedback"> </div>
                        </div>
                    ...
                    <div class="col-md-4 mb-4" style="margin-top: 30px;">
                        <button type="button" class="btn-lectura btn waves-effect waves-light btn-primary" onclick="agregarCarritoUP()">+ Agregar</button>
                    </div>
                </div>
                <div class="content">
                    <div class="row">
