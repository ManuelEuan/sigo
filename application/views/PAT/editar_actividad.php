                    ...
                    <div class="content">
                        <div class="row">
                            <div class="col-md-12 mb-10">
                                ...
                                <textarea class="form-control input-lectura" id="txtSupuesto" name="txtSupuesto" aria-invalid="false" placeholder="" cols="40" rows="5" style=""><?= htmlspecialchars($consulta[0]->vSupuesto) ?></textarea>
                                <div class="invalid-feedback">
                                    Este campo no puede estar vacio.
                                </div>
                            </div>
...
<script>
    ...
    //                     $idActividadGuardada = <?php if ($consulta[0]->iIdActividadMIR == '.' || $consulta[0]->iIdActividadMIR == '') {
                                                        echo 'null';
                                                    } else {
                                                        echo $consulta[0]->iIdActividadMIR;
                                                    } ?>;
            ...
            success: function(resp) {
                ...
                for (let i = 0; i <= parsedData.length; i++) {
                    if (parsedData[i]?.vAreaResponsable != undefined) {
                        $idvResponsable = <?php if ($consulta[0]->vResponsable == '.' || $consulta[0]->vResponsable == '') {
                                                echo 'null';
                                            } else {
                                                echo $consulta[0]->vResponsable;
                                            } ?>;
