...
class C_rods extends CI_Controller {
    ...
    public function index()
    {
        ...
        $data['PP'] = $this->M_rods->obtenerPP();
        $this->load->view('reporte/ods', $data);
    }

    public function dependencias(){
        if($_REQUEST['id']){
            $id = $this->input->post('id',true);
            $respuesta = $this->M_rods->dependencias($id);
    ...
    public function generarrepo()
    {
        ...
        if($query->num_rows() > 0)
        {
            ...
            $cells =[
                ...
                WriterEntityFactory::createCell(''),
                WriterEntityFactory::createCell(''),
                WriterEntityFactory::createCell('Reporte de ODS',$tituloexcel),
            ];
            ...
            $cells = [
                    ...
                    WriterEntityFactory::createCell('ODS',$blueStyle),
                    WriterEntityFactory::createCell('Dependencia',$blueStyle),
                    WriterEntityFactory::createCell('Acciones',$blueStyle),
                    WriterEntityFactory::createCell('Presupuesto',$blueStyle), 
                    WriterEntityFactory::createCell('Presupuesto Ejercido',$blueStyle),
                    WriterEntityFactory::createCell('Personas beneficiadas',$blueStyle),
            ...
            foreach ($records as $rec)
            {
                $cells = [
                    ...
                    WriterEntityFactory::createCell($rec->vOds),
                    ...
                    WriterEntityFactory::createCell($rec->nPresupuestoModificado),
