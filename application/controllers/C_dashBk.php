...
class C_dash extends CI_Controller {
    ...
    public function ficha($id)
    {
        ...
        // Presupuesto Autorizado por la Secretaría de Finanzas  y modificado
        ...
        foreach ($q_fin as $row)
        {
            ...
            $tabla.= '<div class="row">
                        <div class="col-6"><h4><b>Monto autorizado por la Secretaría de Finanzas :</b> $ '.$autorizado.'</h4></div>
    ...
    function datos_grafica_financieros($idAct,$anio=0)
    {
        ...
        $series = "{
                name: 'Presupuesto',
                data: [".json_encode($dpre).",".json_encode($dpre)."],
                color: '#011f4b'
            }, {
                name: 'Autorizado',
                ...
                name: 'Modificado',
                data: [".json_encode($dmod).",".json_encode($dmod)."],
                color: '#6497b1'
