...
class C_rprioritarios extends CI_Controller {
    public function __construct()
    {
        ...
        $this->load->model('M_rprioritarios');
    ...
    public function index()
    {
        ...
        $data['PP'] = $this->M_rprioritarios->obtenerPP();
        $this->load->view('reporte/prioritarios', $data);
    }

    public function dependencias(){
        if($_REQUEST['id']){
            $id = $this->input->post('id',true);
            $respuesta = $this->M_rprioritarios->dependencias($id);
    ...
    public function generarrepo()
    {
        ...
        if($query->num_rows() > 0)
        {
            ...
            $ruta = 'public/reportes/prioritarios.xlsx';
            ...
            $cells =[
                ...
                WriterEntityFactory::createCell(''),
                WriterEntityFactory::createCell(''),
                WriterEntityFactory::createCell('Proyectos Prioritarios',$tituloexcel),
            ];
            ...
            $cells = [
                    ...
                    WriterEntityFactory::createCell('Avance',$blueStyle),
                    WriterEntityFactory::createCell('Personas beneficiados',$blueStyle),
            ...
            foreach ($records as $rec)
            {
                $cells = [
                    ...
                    WriterEntityFactory::createCell($rec->vProyectoPrioritario),
                    ...
                    WriterEntityFactory::createCell($rec->avancedos),
