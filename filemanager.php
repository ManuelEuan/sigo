...
$CONFIG = '{"lang":"en","error_reporting":true,"show_hidden":false,"hide_Cols":false,"calc_folder":false}';
...
$auth_users = array(
    'jorge.estrella' => '$2y$10$.TensQxoV0JNZGq3R2CANugtV0mRNJMoCMI093BiVCHBjaYsYdnxW'
    /*'user' => '$2y$10$.TensQxoV0JNZGq3R2CANugtV0mRNJMoCMI093BiVCHBjaYsYdnxW' //12345*/
);
...
$root_path = $_SERVER['DOCUMENT_ROOT'].'/sigo';
...
$exclude_items = array('filemanager.php');
...
//$max_upload_size_bytes = ((int)str_replace('M','',ini_get('upload_max_filesize')) * 1024);
$max_upload_size_bytes = (int)str_replace('M','',ini_get('upload_max_filesize'));
